...
devSSD1331init(void)
{
	...
	writeCommand(0x00);			//Set outline to green (colour A red)
	writeCommand(0x00);			// Colour B (green)
	writeCommand(0xFF);			// Colour C (blue)
	writeCommand(0xFF);			//Set fill to green (colour A red)
	writeCommand(0x00);			// Colour B (green)
